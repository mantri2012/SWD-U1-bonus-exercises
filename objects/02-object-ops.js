...
let zoo = {
	...
	adultTicketPrice : 25,
	childTicketPrice : 15,
	famousFeatures : ["variety of Animals", "snakes", "Waterfalls"]
}

let garden = {
	name : "Botanical Graden",
	location : "St Charles",
	adultTicketPrice : 15,
	childTicketPrice : 10,
	famousFeatures : ["Greenery", "Beautiful flowers", "Fishes"]
}
...
for (let item of attractions) {
	console.log (`\nNext time you take a road trip to Missouri don't miss ${item.name} in ${item.location}, worth going for watching ${item.famousFeatures[0]}, ${item.famousFeatures[1]} and ${item.famousFeatures[2]}. `);
